...
public final class Endpoints_v1 extends Endpoints {
	...
	public final static String STASH = 						PREFIX_ENDPOINT + "stash/";
	public final static String STASH_DELETE = 				STASH + "delete";
	public final static String STASH_DELTA = 				STASH + "delta";
	public final static String STASH_ITEM = 				STASH + "item/";
	public final static String STASH_MOVE = 				STASH + "move/";
	public final static String STASH_POSITION = 			STASH + "position/";
	public final static String STASH_PUBLISH = 				STASH + "publish";
	...
	public final static String STASH_SPACE = 				STASH + "space";
	public final static String STASH_SUBMIT = 				STASH + "submit";
	public final static String STASH_UPDATE = 				STASH + "update/";
